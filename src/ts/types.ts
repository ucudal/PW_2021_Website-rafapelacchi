...
class User {
    ...
    constructor(nombre: string, mail: string, comentario:string){
        this.nombre = nombre;
        this.mail = mail;
        this.comentario = comentario;
        this.erroresValidacion = new Array<string>();
...
function impactarFormulario(nombre: string, mail: string, comentario: string) {
...
function impactarUsuario(usuario : User){
    var user = {
